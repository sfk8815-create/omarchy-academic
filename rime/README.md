...
- `default.custom.yaml`：基于 [rime-ice](https://github.com/iDvel/rime-ice)（GPL-3.0）的默认配置修改，增加 `,` / `.` 翻页。
...
遵循上游 [GPL-3.0](https://github.com/iDvel/rime-ice/blob/main/LICENSE) 许可。
